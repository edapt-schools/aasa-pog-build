...
import type { KeywordEvidenceResponse } from '@aasa-platform/shared'

interface UseKeywordEvidenceResult {
  data: KeywordEvidenceResponse | null
  loading: boolean
  error: string | null
 ...
 */
export function useKeywordEvidence(ncesId: string | null): UseKeywordEvidenceResult {
  const [data, setData] = useState<KeywordEvidenceResponse | null>(null)
